                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium">Andi Wijaya</td>
                            <td class="px-4 py-3">
                                📞 081234567891 <br />
                                ✉️ andi@mail.com
                            </td>
                            <td class="px-4 py-3">Jl. Merdeka 1</td>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium">Sari Dewi</td>
                            <td class="px-4 py-3">
                                📞 081234567892 <br />
                                ✉️ sari@mail.com
                            </td>
                            <td class="px-4 py-3">Jl. Sudirman 2</td>
                            <td class="px-4 py-3 space-x-2">
                                <button class="px-3 py-1 bg-purple-500 hover:bg-purple-600 text-white rounded">Edit</button>
                                <button class="px-3 py-1 bg-red-500 hover:bg-red-600 text-white rounded">Hapus</button>
                            </td>
