...
templateResult: function(data) {
  ...
  switch (level) {
    case 'gold':
      bgColor = '#FFD700'; iconColor = '#b8860b'; break;
    case 'silver':
      bgColor = '#C0C0C0'; iconColor = '#708090'; break;
    case 'bronze':
      bgColor = '#cd7f32'; iconColor = '#8b4513'; break;
    case 'platinum':
      bgColor = '#e5e4e2'; iconColor = '#6a5acd'; break;
    default:
      bgColor = '#eee'; iconColor = '#555';
  }
